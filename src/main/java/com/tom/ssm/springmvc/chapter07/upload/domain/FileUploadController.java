...
public class FileUploadController {
    ...
    public String uploadForm(){
        // 跳转到文件上传页面
        return "0701/uploadForm";
    }

    @GetMapping(value="/registerUploadForm")
    public String registerForm(){
        // 跳转到文件上传页面
        return "0701/registerForm";
    }


    // 上传文件会自动绑定到MultipartFile中
    @PostMapping(value="/uploadFile11")
    ...
    @PostMapping(value="/registerUpload")
