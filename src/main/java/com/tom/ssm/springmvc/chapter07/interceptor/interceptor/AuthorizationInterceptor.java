package com.tom.ssm.springmvc.chapter07.interceptor.interceptor;
...
public class AuthorizationInterceptor implements HandlerInterceptor {
    ...
    private static final String[] IGNORE_URI = {"/loginInterceptorForm", "/loginInterceptor","/",""};
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (!flag){
            ...
            if(user == null){
                ...
                request.getRequestDispatcher("loginInterceptorForm").forward(request, response);
            }else{
                // 如果用户已经登录，则验证通过，放行
